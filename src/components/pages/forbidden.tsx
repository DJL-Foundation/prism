...
export default function Forbidden({ edit = false }: ForbiddenProps) {
  return (
      ...
      <Card className="max-w-md w-full">
        <CardContent className="pt-6 pb-8 px-6">
          ...
          >
            ...
            >
              {edit
                ? "You are forbidden from editing this presentation. This action is not allowed for your account."
